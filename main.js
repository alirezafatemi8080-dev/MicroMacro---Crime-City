document.addEventListener("DOMContentLoaded", () => {
  ...
  function setTheme(theme) {
    ...
    segBtns.forEach(btn => btn.classList.toggle("active", btn.dataset.theme === theme));
  }
  segBtns.forEach(btn => {
  ...
  mapContainer.style.transform = `translate(-50%, -50%) translate(${posX}px, ${posY}px) scale(${scale})`;
...
[43dcd9a7-70db-4a1f-b0ae-981daa162054](https://github.com/mortenjust/phone-url/tree/d69ca432424c56ab4a718cb9b64874c8fd411f98/index.php?citationMarker=43dcd9a7-70db-4a1f-b0ae-981daa162054&citationId=1&citationId=2&citationId=3 "github.com")0];
